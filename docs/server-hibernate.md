...
`sda-commons-server-hibernate` ships with `org.postgresql:postgresql:42.7.1`, `org.flywaydb:flyway-core:10.7.2`
and `org.flywaydb:flyway-database-postgresql:10.7.2` at compile scope.
