...
7. [sda-commons-server-weld-testing](#7-sda-commons-server-weld-testing)
...
### 7 sda-commons-server-weld-testing

The `sda-commons-server-weld-testing` module has been removed. Please make use of the
official [JUnit5 extension](https://github.com/weld/weld-testing/tree/master/junit5). An example how
