...
Here you can find a [migration guide](https://github.com/SDA-SE/sda-dropwizard-commons/tree/master/docs/migration-guides/MIGRATION_GUIDE_v2_to_v3.md), if you use OpenTracing on your project.
