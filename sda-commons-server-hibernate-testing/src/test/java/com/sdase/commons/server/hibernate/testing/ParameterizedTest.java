package com.sdase.commons.server.hibernate.testing;
...
/**
 * This test ensures that the used rider version is able to run parameterized tests. Versions 1.3.0 and 1.4.0 fail when
 * using the {@link com.github.database.rider.core.DBUnitRule}
 */
