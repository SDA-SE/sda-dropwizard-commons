...
public class JerseyClientExampleApplication extends Application<JerseyClientExampleConfiguration> {
   ...
   private JerseyClientBundle<Configuration> jerseyClientBundle = JerseyClientBundle
         .builder()
         .withConsumerTokenProvider(c -> "MyConsumerToken")
         .build();
   ...
   public void run(JerseyClientExampleConfiguration configuration, Environment environment) {
      ...
      platformClient = jerseyClientBundle.getClientFactory()
            .platformClient()
      ...
      externalClient = jerseyClientBundle.getClientFactory()
            .externalClient()
            .buildGenericClient("externalClient");

      // Example 3:
      // create an external client based on an API that can simply be used as java interface
      apiClient = jerseyClientBundle.getClientFactory()
            .externalClient()
            .api(ApiA.class)
