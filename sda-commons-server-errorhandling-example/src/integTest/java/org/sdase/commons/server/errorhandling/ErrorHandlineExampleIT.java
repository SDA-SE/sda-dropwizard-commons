...
public class ErrorHandlineExampleIT {
   ...
   @ClassRule
   public static final DropwizardAppRule<Configuration> DW = DropwizardRuleHelper
         .dropwizardTestAppFrom(ErrorHandlingExampleApplication.class)
   ...
   public void shouldGetNotFoundException() {
      ...
      assertThat(response.readEntity(ApiError.class).getTitle()).isEqualTo("Not Found: HTTP 404 Not Found");
   }
