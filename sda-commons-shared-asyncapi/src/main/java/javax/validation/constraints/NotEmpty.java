...
/**
 * @deprecated DO NOT USE THIS ANNOTATION! This is included here to make sure that the NotEmpty
 *     annotation from javax.validation:validation-api is available, as the JSON schema generator
 *     requires it. The problem is that NotEmpty is only available in a newer version of
