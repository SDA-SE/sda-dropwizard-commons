...
public class SdaPlatformExampleApplication extends Application<SdaPlatformConfiguration> {
   ...
   public void initialize(Bootstrap<SdaPlatformConfiguration> bootstrap) {
      bootstrap.addBundle(SdaPlatformBundle.builder()
            ...
            // The other values are optional and might also be set using annotations, more details at
            ...
            // Set the name of the license of the API as well as an url to the full license information.
            // Not the license is only an example, this code or the api isn't licensed under Apache 2.0.
