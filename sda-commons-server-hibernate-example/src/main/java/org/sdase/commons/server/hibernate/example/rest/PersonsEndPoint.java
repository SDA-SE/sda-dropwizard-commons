...
public class PersonsEndPoint {
    ...
    * @param p
    *           person to store
    * @return response object with the url of the newly created person in the
    *         location header
    */
   ...
   /**
    * Creates a {@link PersonResource} representing the given
    * {@link PersonEntity}. We do not want to expose the underlying entities to
    * our consumers. This way our API is independent from the internal model
    * which may be changed with an appropriate migration at any time.
    *
    * @param resource
    *           resource that should be mapped
   ...
   /**
    * Creates a {@link PersonEntity} respresenting the given
    * {@link PersonResource}.
    * 
    * @param entity
    *           entity that should be mapped to resource
