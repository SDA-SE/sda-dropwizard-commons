...
/**
 * Default command for database migrations as described in hibernate bundle
 * documentation
 */
public class DbMigrationCommand extends ConfiguredCommand<HibernateExampleConfiguration> {
   ...
   @Override
   protected void run(Bootstrap<HibernateExampleConfiguration> bootstrap, Namespace namespace,
