...
/**
 * Tests that the health checks reports healthy when the ping result is ok and unhealthy if exception is thrown
 */
public class HealthCheckTest {
   ...
   public void shouldBeUnHealthy() {
      // given
      when(dbMock.runCommand(Mockito.any())).thenThrow(new MongoExecutionTimeoutException(1, "DUMMY"));
