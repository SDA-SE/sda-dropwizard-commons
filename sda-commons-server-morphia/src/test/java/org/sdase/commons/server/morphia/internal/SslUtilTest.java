...
public class SslUtilTest {
  ...
  @Test
  public void readLetsEncryptCaIdenTrust()
      throws CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException {
    String pemContent =
        IOUtils.toString(getClass().getResourceAsStream("/le-ca-x3-iden-trust.pem"), "UTF-8");
  ...
  @Test
  public void readLetsEncryptCaIsrg()
      throws CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException {
    String pemContent =
        IOUtils.toString(getClass().getResourceAsStream("/le-ca-x3-isrg-x1.pem"), "UTF-8");
