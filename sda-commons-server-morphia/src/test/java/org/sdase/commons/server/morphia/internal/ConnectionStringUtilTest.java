...
public class ConnectionStringUtilTest {
   ...
   public void testUriBuilderUserPassword() {
      ...
      assertThat(connectionString)
            .isNotNull()
            .isEqualTo("mongodb://dbuser:sda123@db1.example.net:27017,db2.example.net:2500/default_db?replicaSet=test");
   }
   ...
   public void testUriBuilderWithoutUserPassword() {
      ...
      assertThat(connectionString)
            .isNotNull()
            .isEqualTo("mongodb://db1.example.net:27017,db2.example.net:2500/default_db?replicaSet=test");
   }
