...
class KeyMgmtBundleWithPlaceholderTest {
  ...
  void shouldGetMappingValueToApiCaseSensitive() {
    ...
    // fail case
    assertThat(gender.toApi("f")).isEqualTo("API_PLACEHOLDER");
  }
  ...
  void shouldMapBiDirectionalMappings() {
    ...
    // fail case
    assertThat(keyMapper.toImpl("B")).isEqualTo("IMPL_PLACEHOLDER");
  }

  @Test
  void shouldThrowWhenKeyMapperNameIsNullOrEmpty() {
    assertThrows(IllegalArgumentException.class, () -> keyMgmtBundle.createKeyMapper(null));
    assertThrows(IllegalArgumentException.class, () -> keyMgmtBundle.createKeyMapper(""));
  }
  ...
  public static class KeyMgmtBundleTestApp extends Application<KeyMgmtBundleTestConfig> {
    ...
    private final KeyMgmtBundle<KeyMgmtBundleTestConfig> keyMgmt =
        KeyMgmtBundle.builder()
            ...
            .withApiPlaceholder("API_PLACEHOLDER")
            .withImplPlaceholder("IMPL_PLACEHOLDER")
            .build();
