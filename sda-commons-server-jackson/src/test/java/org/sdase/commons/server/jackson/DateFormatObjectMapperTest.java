...
public class DateFormatObjectMapperTest {
   ...
   public void readIso8601UtcTimeAsDate() throws Exception {
      ...
      ZoneOffset zoneOffset = ZoneOffset.systemDefault().getRules().getOffset(Instant.ofEpochMilli(date.getTime()));
   ...
   public void writeIso8601UtcTime() throws Exception {
      ZonedDateTime given = ZonedDateTime.of(LocalDateTime.of(2018, 11, 21, 13, 16, 47), ZoneOffset.UTC);
   ...
   public void writeIso8601CetTime() throws Exception {
      ZonedDateTime given = ZonedDateTime.of(
            LocalDateTime.of(2018, 11, 21, 13, 16, 47),
            ZoneId.of("CET")
      );
   ...
   public void writeIso8601CetTimeWithNanos() throws Exception {
      ZonedDateTime given = ZonedDateTime.of(
            LocalDateTime.of(2018, 11, 21, 13, 16, 47, 965_000_300),
            ZoneId.of("CET")
      );
   ...
   public void writeIso8601WithMillisCetIfMillisSet() throws Exception {
      DateTimeHolder given = new DateTimeHolder().setZonedDateTimeWithMillis(
   ...
   public void writeIso8601WithSecondsCetIfOnlyMinutesSet() throws Exception {
      ZonedDateTime given = ZonedDateTime.of(LocalDateTime.of(2018, 11, 21, 13, 16), ZoneId.of("CET"));
   ...
   public void writeIso8601UsingConfigWithMillisCetIfNanosSet() throws Exception {
      ZonedDateTime given = ZonedDateTime.of(LocalDateTime.of(2018, 11, 21, 13, 16, 47, 965_000_300), ZoneId.of("CET"));
   ...
   public void writeIso8601UsingConfigWithMillisCetIfSecondsSet() throws Exception {
      ZonedDateTime given = ZonedDateTime.of(LocalDateTime.of(2018, 11, 21, 13, 16, 47), ZoneId.of("CET"));
   ...
   public void readIso8601WithNanosInPropertyFormattedWithMillis() throws Exception {
      String given = '{' + asJsonString("zonedDateTimeWithMillis") + ':' + asJsonString("2018-11-21T13:16:47.9650003Z") + '}';

      DateTimeHolder dateTimeHolder = om.readValue(given, DateTimeHolder.class);

      assertThat(dateTimeHolder.getZonedDateTimeWithMillis()).isEqualTo("2018-11-21T13:16:47.9650003Z");
   }

   @Test
   public void readIso8601WithSecondsInPropertyFormattedWithMillis() throws Exception {
      String given = '{' + asJsonString("zonedDateTimeWithMillis") + ':' + asJsonString("2018-11-21T13:16:47Z") + '}';
   ...
   public void writeIso8601WithSecondsCetIfMillisSet() throws Exception {
      DateTimeHolder given = new DateTimeHolder().setZonedDateTime(
            ZonedDateTime.of(LocalDateTime.of(2018, 11, 21, 13, 16, 47), ZoneId.of("CET"))
                  .plus(965, ChronoUnit.MILLIS));
   ...
   public void readIso8601WithNanosInPropertyFormattedWithSeconds() throws Exception {
      String given = '{' + asJsonString("zonedDateTime") + ':' + asJsonString("2018-11-21T13:16:47.9650003Z") + '}';
   ...
   public void readIso8601WithSecondsInPropertyFormattedWithSeconds() throws Exception {
      String given = '{' + asJsonString("zonedDateTime") + ':' + asJsonString("2018-11-21T13:16:47Z") + '}';
