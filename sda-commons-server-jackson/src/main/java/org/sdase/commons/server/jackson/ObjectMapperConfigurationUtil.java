 ...
 * {@link io.openapitools.jackson.dataformat.hal.annotation.EmbeddedResource}.
 */
public class ObjectMapperConfigurationUtil {
   ...
   public static class Builder {
      ...
      /**
       * Allows customization of the {@link ObjectMapper}. More customizers may be added by calling this method
       * multiple times.
       * @param customizer receives the {@link ObjectMapper} for customization, e.g. to enable or disable specific
