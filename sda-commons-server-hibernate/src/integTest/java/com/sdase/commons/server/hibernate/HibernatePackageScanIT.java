...
import com.sdase.commons.server.hibernate.test.HibernateITestConfiguration;
import com.sdase.commons.server.hibernate.test.HibernatePackageScanApp;
...
public class HibernatePackageScanIT {
   ...
   public static final DropwizardAppRule<HibernateITestConfiguration> DW =
         new DropwizardAppRule<>(HibernatePackageScanApp.class, ResourceHelpers.resourceFilePath("test-config.yaml"));
