...
@DBUnit(url = HibernateNoPackageScanIT.DB_URI,  driver = "org.h2.Driver", user = "sa", password = "sa")
public class HibernateNoPackageScanIT {
   ...
   public static final DropwizardAppRule<HibernateITestConfiguration> DW =
         new DropwizardAppRule<>(HibernateNoPackageScanApp.class, ResourceHelpers.resourceFilePath("test-config.yaml"));
