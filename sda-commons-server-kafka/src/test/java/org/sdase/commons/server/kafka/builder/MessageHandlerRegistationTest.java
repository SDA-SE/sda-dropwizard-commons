...
public class MessageHandlerRegistationTest {
  ...
  public void handlerIsRegisteredCorrectly() {
    ...
    CallbackMessageHandler<String, String> cbHandler =
    ...
    MessageHandlerRegistration<String, String> registration1 =
        MessageHandlerRegistration.<String, String>builder()
            .withListenerConfig(ListenerConfig.getDefault())
  ...
  public void serializerAndPollIntervalAreSetCorrectly() {
    ...
    MessageHandlerRegistration<Integer, Long> registration =
        MessageHandlerRegistration.<Integer, Long>builder()
