 ...
 * in the constructor. Potential {@link SerializationException} exceptions are caught and logged.
 * </p>
 * <p>
 *   Result of the serialization is then a {@link DeserializerResult} with the raw value and either
...
public class NoSerializationErrorDeserializer<T> implements Deserializer<DeserializerResult<T>> {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(NoSerializationErrorDeserializer.class);
