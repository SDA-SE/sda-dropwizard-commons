...
/**
 * The central definition of the message consumer duration histogram. This is
 * the definition of the message consumed duration histogram as it should be
 * provided by all Kafka consumers to measure message process durations with
 * Prometheus.
 */
public class ConsumerTopicMessageHistogram {
   ...
   /**
    * The labels added by {@code ConsumerTopicMessageHistogram}. The labels and
    * their order have to be aligned with the values created in
    * {@link #createLabelValuesForCurrentMessage(String, String)}
    */
   ...
   /**
    * Creates and registers a new {@link Histogram} matching the specification
    * of this {@code ConsumerTopicMessageHistogram} instance. <strong>Note that
    * there should be only one registered instance of this type in the
    * application.</strong>
    */
   ...
   /**
    * Creates all values for the labels required by the histogram in appropriate
    * order.
    * 
    * @param producerName
    * @param topicName
   ...
   /**
    * Builds the {@link Histogram} to measure message consumer duration and
    * registers it.
    *
   ...
   private Histogram createAndRegister() {
      Histogram.Builder histogramBuilder = Histogram.build().name(METRIC_NAME).labelNames(LABELS).help(HELP);
