...
/**
 * @deprecated Strategy that supports the legacy implementation used before the
 *             introduction of {@link MessageListenerStrategy}.
 *             <p>
 *             The strategy is configurable but not very flexible. The strategy
 *             pattern should provide more flexibility to the developer to
 *             influence the behavior of Kafka communication.
 *             </p>
 */
@Deprecated
public class LegacyMLS<K, V> extends MessageListenerStrategy<K, V> {
   ...
   public LegacyMLS(MessageHandler<K, V> handler, ErrorHandler<K, V> errorHandler, boolean autoCommitOnly,
