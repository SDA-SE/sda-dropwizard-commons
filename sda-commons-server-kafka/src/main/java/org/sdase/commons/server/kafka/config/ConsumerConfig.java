...
public class ConsumerConfig {
  ...
  /**
   * Convenience for setting Kafka's property {@code 'group.id'}. Will not work if you manually add
   * that property to {@link #config}.
   */
  @NotNull private String group = "default";

  /**
   * Convenience for setting Kafka's property {@code 'client.id'}. Will not work if you manually add
   * that property to {@link #config}.
   */
