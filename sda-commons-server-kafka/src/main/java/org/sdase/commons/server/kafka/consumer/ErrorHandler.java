...
/**
 * Interface for handling errors that might occur during the processing of Kafka records. Be aware
 * that the key or value can be null if the WrappedNoSerializationErrorDeserializer is used.
 *
...
public interface ErrorHandler<K, V> {
   ...
   *
   * @param consumerRecord consumer record that caused the error
