...
/**
 * <p>
 *    This filter adds headers to the response that enhance the security of web applications. Usually we do not provide
 *    web content from services. But we address the risks identified in the security guide as:
 * </p>
 * <ul>
 *    <li>"Risiko: Clickjacking"</li>
 *    <li>"Risiko: Interpretation von Inhalten durch den Browser"</li>
 *    <li>"Risiko: Cross Site Scripting (XSS)"</li>
 *    <li>"Risiko: Weitergabe von besuchten URLs an Dritte"</li>
 *    <li>"Risiko: Nachladen von Inhalten in Flash und PDFs"</li>
 * </ul>
 */
public class WebSecurityHeaderFilter implements ContainerResponseFilter {
   ...
   private void addHeaderIfAbsent(ContainerResponseContext response, String headerName, String headerValue) {
      if (response.getHeaders().get(headerName) == null || response.getHeaders().get(headerName).isEmpty()) {
