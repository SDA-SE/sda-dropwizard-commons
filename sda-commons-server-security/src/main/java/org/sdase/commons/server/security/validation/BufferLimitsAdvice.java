...
/**
 * <p>
 *    Checks that secure limits of used {@link io.dropwizard.jetty.HttpConnectorFactory} instances are used to avoid the
 *    risk of buffer overflow attacks. This class checks for the risks identified in the security guide as:
 * </p>
 * <ul>
 *    <li>"Risiko: Buffer Overflow"</li>
 * </ul>
 */
