 ...
 * how they are called for easier extension with more supported bundles.
 */
public interface CustomConfigurationProviders {
   ...
   interface CorsConfigProviderBuilder<C extends Configuration> {
      ...
      /**
       * Disable CORS support. Browsers are not allowed to access the application from a foreign domain.
       *
       * @return the builder instance
       */
      ...
      /**
       *
       * @param corsConfigProvider a provider, for the {@link org.sdase.commons.server.cors.CorsConfiguration}, e.g.
       *                           {@code MyAppConfig::getCors}
       * @return the builder instance
       */
   ...
   interface ConsumerTokenConfigBuilder<C extends Configuration> {
      ...
      /**
       * Disable consumer token support. Consumer tokens are not required to access this service and will be ignored if
       * a client sends them.
       *
       * @return the builder instance
       */
      ...
      /**
       * Disable consumer token support. Consumer tokens are not required to access this service but will be tracked if
       * a client sends them.
       *
       * @return the builder instance
       */
      ...
      /**
       * Enable consumer token support. Consumer tokens are required to access this service. Further configuration may
       * exclude paths from this requirement.
       *
       * @return the builder instance
       */
   ...
   interface ConsumerTokenRequiredConfigBuilder<C extends Configuration> extends SwaggerTitleBuilder<C> {
   ...
   interface SwaggerFinalBuilder<C extends Configuration> extends SwaggerScanningBuilder<C>, PlatformBundleBuilder<C> {}
}
