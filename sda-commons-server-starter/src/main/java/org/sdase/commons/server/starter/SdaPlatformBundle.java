...
public class SdaPlatformBundle<C extends Configuration> implements ConfiguredBundle<C> {
  ...
  public static class Builder<C extends Configuration>
    ...
    @Override
    public SwaggerTitleBuilder<C> withConsumerTokenConfigProvider(
    ...
    private SwaggerBundle.FinalBuilder createSwaggerBundleBuilder() {
      ...
      SwaggerBundle.InterimBuilder interimBuilder =
          SwaggerBundle.builder().withTitle(swaggerInfo.getTitle());
      SwaggerBundle.FinalBuilder finalBuilder =
          interimBuilder.addResourcePackage(swaggerResourcePackages.get(0));
      if (swaggerResourcePackages.size() > 1) {
        for (String swaggerResourcePackage :
            swaggerResourcePackages.subList(1, swaggerResourcePackages.size())) {
    ...
    private SwaggerBundle.FinalBuilder applySwaggerContactInfo(
        SwaggerBundle.FinalBuilder finalBuilder) {
    ...
    private SwaggerBundle.FinalBuilder applySwaggerLicenseInfo(
        SwaggerBundle.FinalBuilder finalBuilder) {
