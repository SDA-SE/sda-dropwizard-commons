...
public class DefaultLoggingConfigurationBundleWithEmptyConfigTest {

  @ClassRule
  public static final DropwizardAppRule<Configuration> DW =
      new DropwizardAppRule<>(LoggingTestApp.class, resourceFilePath("with-empty-config.yaml"));

  @Test()
  public void shouldNotApplyConsoleAppender() {
