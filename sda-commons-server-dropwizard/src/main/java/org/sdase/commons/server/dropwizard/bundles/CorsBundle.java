...
public class CorsBundle<C extends Configuration> implements ConfiguredBundle<C> {
  ...
  protected CorsBundle(CorsBundle<C> corsBundle) {
    this.configProvider = corsBundle.configProvider;
    this.allowedHttpMethods = corsBundle.allowedHttpMethods;
    this.allowedHeaders = corsBundle.allowedHeaders;
    this.exposedHeaders = corsBundle.exposedHeaders;
  }
  ...
  public interface FinalBuilder<C extends Configuration> {
     ...
     * cross-origin clients. The given {@code httpMethods} overwrite the {@link
     * #DEFAULT_HTTP_METHODS default methods}.
     *
     * <ul>
  ...
  public static class Builder<C extends Configuration> implements InitialBuilder, FinalBuilder<C> {
    ...
    // TODO next-major consider this constructor as private and remove when deprecated subclass is
    // removed
    protected Builder(CorsConfigProvider<C> configProvider) {
      this.configProvider = configProvider;
    }
