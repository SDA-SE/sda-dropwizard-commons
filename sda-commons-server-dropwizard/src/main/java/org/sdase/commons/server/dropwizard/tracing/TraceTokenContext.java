 ...
 * messages across services for a single synchronous process. It will be logged as {@link MDC} key
 * {@value #TRACE_TOKEN_MDC_KEY}.
 */
public class TraceTokenContext implements Closeable {
  ...
  /** The key of the trace token in the {@link MDC}. */
  ...
  protected TraceTokenContext(boolean created, String traceToken) {
