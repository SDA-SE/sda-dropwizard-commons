...
/**
 * <p>
 * JUnit Test rule for running a AWS S3-compatible object storage alongside the
 * (integration) tests. Use {@link #getEndpoint()} to retrieve the endpoint URL
 * to connect to.
 * </p>
 * <p>
 * Example usage:
...
public class S3MockRule extends ExternalResource {
   ...
   /**
    * Clears all buckets and objects from the store. Afterwards restores all
    * buckets and object specified during creation.
    */
   ...
   public AmazonS3 getClient() {
      return AmazonS3ClientBuilder
            ...
            .withEndpointConfiguration(
                  new AwsClientBuilder.EndpointConfiguration(getEndpoint(), Regions.DEFAULT_REGION.getName()))
