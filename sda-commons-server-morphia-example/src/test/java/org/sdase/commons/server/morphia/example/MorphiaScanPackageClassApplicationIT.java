...
class MorphiaScanPackageClassApplicationIT {
  ...
  @RegisterExtension
  @Order(1)
  static final DropwizardAppExtension<MorphiaApplicationConfiguration> DW =
      new DropwizardAppExtension<>(
          MorphiaScanPackageClassApplication.class,
          null,
  ...
  @BeforeEach
  void beforeEach() {
    MorphiaScanPackageClassApplication app = DW.getApplication();
    carManager = app.getCarManager();
