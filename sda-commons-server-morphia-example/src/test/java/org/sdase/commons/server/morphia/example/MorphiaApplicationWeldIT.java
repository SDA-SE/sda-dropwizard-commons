...
/** Demonstration how to use the {@link MongoDbRule} with Weld. */
public class MorphiaApplicationWeldIT {
  ...
  private static final WeldAppRule<MorphiaApplicationConfiguration> APP_RULE =
      new WeldAppRule<>(
          MorphiaApplicationWeld.class, // normal WELD rule initialization
          null,
  ...
  @Before
  public void before() {
    MorphiaApplicationWeld app = APP_RULE.getApplication();
