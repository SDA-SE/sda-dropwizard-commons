...
/** Demonstration how to use the {@link MongoDbRule}. */
public class MorphiaApplicationJUnit4IT {

  private static final MongoDbRule MONGODB =
      MongoDbRule.builder()
          .build(); // start a flapdoodle mongodb instance for this test. A random port is used.

  private static final DropwizardAppRule<MorphiaApplicationConfiguration> APP_RULE =
  ...
  @Before
  public void before() {
    MorphiaApplication app = APP_RULE.getApplication();
