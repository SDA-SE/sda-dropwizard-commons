...
/**
 * Utility class to create AssertJ test {@link Condition}s for {@link ClientRequestException}s. The created conditions
 * can be used with {@link org.assertj.core.api.ThrowableAssert#is(Condition)} or
