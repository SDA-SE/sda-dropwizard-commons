...
public class ClientRequestExceptionMapperTest {
   ...
   public void mapNotFound() {
      ...
      assertThat((ApiError) response.getEntity())
            ...
            .asString().isNotBlank().contains("404");
   }

   @Test
   public void mapInternalServerError() {
      ClientRequestException exception = new ClientRequestException(
      ...
      assertThat((ApiError) response.getEntity())
            .extracting(ApiError::getTitle)
            .asString().isNotBlank().contains("500");
   }
   ...
   public void mapUnknownClientError() {
      ...
      assertThat((ApiError) response.getEntity())
            .extracting(ApiError::getTitle)
            .asString().isNotBlank().contains("418");
   }
   ...
   public void jsonProcessing() {
      ClientRequestException exception = new ClientRequestException(
            new ProcessingException(
                  new JsonParseException(mock(JsonParser.class), "No message")
            )
      );
      ...
      assertThat((ApiError) response.getEntity())
            .extracting(ApiError::getTitle)
            .asString().isNotBlank().containsIgnoringCase("processing");
   }
