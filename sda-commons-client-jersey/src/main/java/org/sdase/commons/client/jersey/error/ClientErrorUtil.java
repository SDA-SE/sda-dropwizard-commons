...
public class ClientErrorUtil {
   ...
   * @return the error data or {@code null} if the response is neither a client error (4xx) nor a
   *     server error (5xx).
   * @throws ProcessingException if the content of the message cannot be mapped to an entity of the
   *     requested type. See {@link Response#readEntity(Class)}
   * @throws IllegalStateException if the entity is not backed by an input stream, the response has
   *     been {@link Response#close() closed} already, or if the entity input stream has been fully
   *     consumed already and has not been buffered prior consuming. See {@link
   ...
   * @return the error data or {@code null} if the given {@link ClientRequestException} does not
   *     contain a {@link WebApplicationException} with a {@link Response} that is a client error
   *     (4xx) or a server error (5xx).
   * @throws ProcessingException if the content of the message cannot be mapped to an entity of the
   *     requested type. See {@link Response#readEntity(Class)}
   * @throws IllegalStateException if the entity is not backed by an input stream, the response has
   *     been {@link Response#close() closed} already, or if the entity input stream has been fully
   ...
   * @return the response body converted to the desired {@code errorType} or {@code null} if the
   *     response is neither a client error (4xx) nor a server error (5xx).
   * @throws ProcessingException if the content of the message cannot be mapped to an entity of the
   *     requested type. See {@link Response#readEntity(Class)}
   * @throws IllegalStateException if the entity is not backed by an input stream, the response has
   *     been {@link Response#close() closed} already, or if the entity input stream has been fully
   ...
   *     response is neither a client error (4xx) nor a server error (5xx).
   * @throws ProcessingException if the content of the message cannot be mapped to an entity of the
   *     requested type. See {@link Response#readEntity(GenericType)}
   * @throws IllegalStateException if the entity is not backed by an input stream, the response has
   *     been {@link Response#close() closed} already, or if the entity input stream has been fully
   *     consumed already and has not been buffered prior consuming. See {@link
  ...
  /**
   * Read json body of the request encapsulated in the given {@link ClientRequestException} as
   * {@code errorType}.
   *
   * @param e the error occurred when requesting a resource.
   * @param errorType the expected type of the data in the response body
   * @param <E> the type the response body is converted to
   * @return the response body converted to the desired {@code errorType} or {@code null} if the
   *     given {@link ClientRequestException} does not contain a {@link WebApplicationException}
   *     with a {@link Response} that is a client error (4xx) or a server error (5xx).
   * @throws ProcessingException if the content of the message cannot be mapped to an entity of the
   *     requested type. See {@link Response#readEntity(Class)}
   * @throws IllegalStateException if the entity is not backed by an input stream, the response has
   *     been {@link Response#close() closed} already, or if the entity input stream has been fully
  ...
  /**
   * Wrapped around a request from a {@link
   * org.sdase.commons.client.jersey.builder.PlatformClientBuilder#buildGenericClient(String)
   * platform generic client} of a {@link
   ...
   * or {@link org.sdase.commons.client.jersey.builder.ExternalClientBuilder#api(Class) external api
