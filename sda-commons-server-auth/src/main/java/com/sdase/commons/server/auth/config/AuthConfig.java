...
public class AuthConfig {
   ...
   /**
    * The default window in seconds in which the Not Before, Issued At and Expires At Claims will still be valid.
    */
   private long leeway = 0;

   /**
    * Used to disable authentication for local development and unit testing. Should NEVER be set in production.
    */
