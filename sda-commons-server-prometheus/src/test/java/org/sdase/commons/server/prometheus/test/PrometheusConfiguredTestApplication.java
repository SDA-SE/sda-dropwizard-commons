...
public class PrometheusConfiguredTestApplication extends Application<PrometheusTestConfiguration> {
  ...
  @Override
  public void initialize(final Bootstrap<PrometheusTestConfiguration> bootstrap) {
  ...
  @Override
  public void run(PrometheusTestConfiguration config, final Environment environment) {
        ...
        .register(
            ...
            new HealthCheck() {
              ...
              protected Result check() {
                return Result.unhealthy("always unhealthy");
              }
            });
    ...
    environment
        ...
        .register(
            ...
            new HealthCheck() {
              @Override
              protected Result check() {
                return Result.healthy("always healthy");
              }
            });
