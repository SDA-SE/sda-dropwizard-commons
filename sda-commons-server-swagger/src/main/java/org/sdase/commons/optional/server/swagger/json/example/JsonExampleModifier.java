...
/**
 * Converts examples from the sagger annotations from simple strings into JSON to allow to use the
 * full expressiveness of swagger.
 */
@SwaggerDefinition
public class JsonExampleModifier implements ReaderListener {
  ...
  public void afterScan(Reader reader, Swagger swagger) {
    ...
    if (swagger.getPaths() != null) {
      swagger
          .getPaths()
          .forEach((key, path) -> path.getOperations().forEach(this::updateOperations));
    }
  }
