...
/**
 * This test suite checks if the correct swagger file is generated if multiple
 * different apps are executed in the same JVM.
 */
public class SwaggerBundleMultipleApplicationsIT {
   @Rule
   public final DropwizardAppRule<Configuration> DW = new DropwizardAppRule<>(SwaggerBundleTestApp.class,
